	...
	def __init__(self, spreadsheet_name):
		...
		if mat!=[]:
			for i in mat:
				...
				self.sheet.update_cell(count, self.col_new_cases, i[3])
				self.sheet.update_cell(count, self.col_new_deaths, i[4])

statsupdate = AutoStatUpdater2('CoronavirusTracker')
